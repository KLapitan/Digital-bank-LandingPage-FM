              ...
              <div className="h-screen  flex flex-col lg:flex-row-reverse md:gap-2   w-full  bg-NGray50  lg:h-143  lg:overflow-hidden">
                   {/* bg-image of the phone  */}
                     <div className="lg:w-3xl h-80  lg:h-screen bg-size-[100%] bg-center bg-[url('src/assets/images/bg-intro-mobile.svg')] bg-no-repeat md:bg-size-[100%] md:bg-center lg:bg-[url('src/assets/images/bg-intro-desktop.svg')]  lg:bg-size-[190%] lg:bg-bottom-left  lg:overflow-hidden    "></div>
                      ...
                      {/* details  */}
                      <div className="w-auto h-auto  flex flex-col   items-center gap-4 mt-5  lg:gap-8 lg:justify-center lg:items-start   lg:w-lg   lg:mr-2 ">
                            <h2 className=" text-4xl w-89  md:text-5xl   lg:text-5xl text-center font-light tracking-tight text-PBlue950 lg:text-left lg:w-100 lg:ml-6 ">Next generation digital banking</h2>

                            <p className="text-center w-90   text-md p-2 tracking-tight leading-5 text-NGray600 md:text-center  md:w-md md:h-32 lg:text-left lg:w-95 lg:ml-6 ">Take your financial life online. Your Digitalbank account will be a one-stop-shop 
                              for spending, saving, budgeting, investing, ands much more.</p>  
                     <DBankInviteButton className="mt-2 lg:-mt-18 lg:ml-7">Request Invite</DBankInviteButton>
                      </div>
