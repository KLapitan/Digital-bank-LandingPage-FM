...
<div className="h-80 scale-100 relative bg-[url('src/assets/images/bg-intro-mobile.svg')] md:bg-[url('src/assets/images/bg-intro-desktop.svg')] bg-no-repeat bg-cover bg-center ">
</div>

{/* phone image */} 
<picture>
<img src="src/assets/images/image-mockups.png" alt="phones" className={`p-2 w-90 h-115 absolute -top-35 left-2 z-10 ${showLinks ? "hidden":"block"}`} />
</picture> 

</div>

<div className="h-auto w-full  font-PublicSans text-center flex flex-col gap-4 mt-3 p-3">
