          ...
          <div className="h-screen  relative overflow-hidden lg:h-155 border lg:bg-NGray100 z-40 ">
              ...
              <div className="h-screen flex flex-col lg:flex-row-reverse w-full  bg-NGray50  lg:h-143   lg:overflow-hidden">
                   {/* bg-image of the phone  */}
                     <div className="lg:w-3xl h-86 lg:h-screen bg-[url('src/assets/images/bg-intro-mobile.svg')] bg-no-repeat bg-cover lg:bg-[url('src/assets/images/bg-intro-desktop.svg')]  lg:bg-size-[165%] lg:bg-bottom-left  lg:overflow-hidden  border"></div>

                      {/* details  */}
                      <div className="w-auto h-auto flex flex-col  items-start border gap-4 mt-5 lg:gap-8 lg:justify-center   lg:w-xl lg:mr-2 ">
