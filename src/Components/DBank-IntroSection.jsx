          ...
          <div className="h-screen   relative overflow-hidden lg:h-165  lg:bg-NGray100 z-40 ">
                {/* large view */}
                  <picture className="hidden lg:block z-50 absolute lg:-top-56 lg:-right-40 lg:scale-85">
                    <img src="/images/image-mockups.png" alt="mockup" className="phone" />
                  </picture>

                {/* small view */}
                <picture className="lg:hidden z-40 absolute -top-37  md:left-32  p-2 scale-100">
                    <img src="/images/image-mockups.png" className="w-full md:w-130 h-115" alt="mockup"  />
                  </picture>
              ...
              <div className="h-screen  flex flex-col lg:flex-row-reverse md:gap-2   w-full  bg-NGray50  lg:h-142  lg:overflow-hidden">
                   {/* bg-image of the phone  */}
                     <div className="lg:w-3xl h-80  lg:h-screen bg-size-[100%] bg-center bg-[url('/images/bg-intro-mobile.svg')] bg-no-repeat md:bg-size-[100%] md:bg-center lg:bg-[url('/images/bg-intro-desktop.svg')]  lg:bg-size-[190%] 2xl:bg-size-[195%] lg:bg-bottom-left  lg:overflow-hidden    "></div>
